<!--Author:
	Date:
	File:	  FixIt5.php
	Purpose:  What's wrong here? Now we are using an associative array to store 
	our quarterly sale, using the name of each quarter ('quarter1', 'quarter2', 
	etc) as key values instead of indexing the array with numbers. The program 
	runs but the total is 0. What have we done wrong!
-->
